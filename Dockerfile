...
RUN curl -fSL "https://extdist.wmflabs.org/dist/extensions/MobileFrontend-REL1_29-00fab28.tar.gz" -o MobileFrontend.tar.gz \
...
RUN curl -fSL "https://extdist.wmflabs.org/dist/extensions/VisualEditor-REL1_29-ef45039.tar.gz" -o VisualEditor.tar.gz \
